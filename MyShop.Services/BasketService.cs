...
namespace MyShop.Services
{
    public class BasketService : IBasketService
    {
        ...
        {
            Basket basket = GetBasket(httpContext, false);  // get basket from database. False becasue if the basket does not exist we do not want it to create one
        ...
        public BasketSummaryViewModel  GetBasketSummary(HttpContextBase httpContext)
        {
            ...
            if (basket != null)
            {
                int? basketCount = (from item in basket.BasketItems   // int? allows th value to be nulll
